  ...
  def accecpted_friends
   AccecptedFriend.where("user_id_1 = #{self.uid.to_s} OR user_id_2 =#{self.uid.to_s}")
  end
  ...
  def what_friends_are_doing
    ...
    events_to_ignore=[]
    friends =   AccecptedFriend.where("user_id_1 = #{self.uid.to_s} OR user_id_2 =#{self.uid.to_s}")
